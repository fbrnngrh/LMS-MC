                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="pt-4">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" name="email" id="email" placeholder="Password Confirmation">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-group mb-3">
                                    <span class="la la-lock input-icon"></span>
                                    <input class="form-control form--control password-field" type="password" name="password_confirmation" id="password_confirmation" placeholder="Password Confirmation">
                                </div>
                            </div><!-- end input-box -->
                            <div class="btn-box">
